...
EMAIL_HOST_USER = 'dan.morain91@gmail.com'
EMAIL_HOST_PASSWORD = 'Mosiah5:13'
EMAIL_PORT = 587
DEFAULT_FROM_EMAIL = 'dan.morain91@gmail.com'
...
SECRET_KEY = 'jy00*xg7ne$%n%&=2ve##&*uv%8s8q1kpdbo+yk(@w#b6)iam3'
...
DATABASES = {
    'default': {
                ...
                'NAME': 'chf',                      # Or path to database file if using sqlite3.
